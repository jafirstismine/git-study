...
public class UsersController {
    ...
    public String insert(@Param("name") String name,@Param("pwd") String pwd,@Param("realname") String realname,@Param("sex") String sex,
                         @Param("age") Integer age,@Param("card") String card,@Param("address") String address,@Param("Phone") String phone,
                         @Param("email")String email,@Param("code")String code,@Param("type")Integer type){
            ...
            sex = new String(sex.getBytes(StandardCharsets.ISO_8859_1),StandardCharsets.UTF_8);
            card = new String(card.getBytes(StandardCharsets.ISO_8859_1),StandardCharsets.UTF_8);
            ...
            code = new String(code.getBytes(StandardCharsets.ISO_8859_1),StandardCharsets.UTF_8);
